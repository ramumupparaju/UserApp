...
public class ShowRoomAdapter extends BaseRecyclerViewAdapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ((ShowRoomAdapter.ViewHolder) holder).bind(showRoomResponse, position);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bind(ProductInfoResponse productInfoResponse, int position) {
            binding.setVariable(BR.productinforesponse, productInfoResponse);
